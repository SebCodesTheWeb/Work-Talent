...
export const Portfolio = ({
    ...
    <VStack alignItems="start" w="full" spacing={ 4 }>
       <Heading as="h2" size="lg">Step { currentStep }: Portfolio </Heading>
       ...
       <Input
        ...
        />
        <FormLabel htmlFor="portfolio.description">Describe your project, goals, challenges, in under 100 words: </FormLabel>
       <Textarea
