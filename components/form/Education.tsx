...
export const Education = ({
    ...
    <VStack alignItems="start" w="full" spacing={ 4 }>
       ...
       <Input
        ...
        />
        <FormLabel htmlFor="education.program">What program did you study</FormLabel>
       <Input
          name="education.program"
          onChange={ handleChange }
          value={ values.education.program }
        />
        <FormLabel htmlFor="education.dateOfFinishing">When did you finnish school</FormLabel>
       <Input
